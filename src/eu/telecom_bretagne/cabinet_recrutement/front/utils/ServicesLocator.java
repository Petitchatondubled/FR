...
public class ServicesLocator
{
	...
	public Object getRemoteInterface(String nomEJB) throws ServicesLocatorException
	{
		...
		if(nomEJB.equals("ServiceEntreprise"))
			...
			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/ServiceEntreprise!eu.telecom_bretagne.cabinet_recrutement.service.IServiceCandidature";
		else if(nomEJB.equals("ServiceOffreEmploi"))
			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/ServiceEntreprise!eu.telecom_bretagne.cabinet_recrutement.service.IServiceOffreEmploi";
		else if(nomEJB.equals("ServiceSecteurActivite"))
			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/ServiceEntreprise!eu.telecom_bretagne.cabinet_recrutement.service.IServiceSecteurActivite";
		else if(nomEJB.equals("ServiceNiveauQualification"))
			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/ServiceEntreprise!eu.telecom_bretagne.cabinet_recrutement.service.IServiceNiveauQualification";
		else if(nomEJB.equals("ServiceMessageCand"))
			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/ServiceEntreprise!eu.telecom_bretagne.cabinet_recrutement.service.IServiceMessageCand";
		else if(nomEJB.equals("ServiceMessageOffre"))
			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/ServiceEntreprise!eu.telecom_bretagne.cabinet_recrutement.service.IServiceMessageOffre";
		else
...
//		else if(nomEJB.equals("MessageCandDAO"))
//			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/MessageCandDAO!eu.telecom_bretagne.cabinet_recrutement.data.dao.MessageCandDAO";
//		else if(nomEJB.equals("MessageOffreDAO"))
//			nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/MessageOffreDAO!eu.telecom_bretagne.cabinet_recrutement.data.dao.MessageOffreDAO";
//		else
//			throw new ServicesLocatorException("Il n'y a pas d'EJB avec ce nom...");
